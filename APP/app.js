...
app.patch("/api/articles/:article_id", patchCommentsByArticleID);

app.use((err, req, res, next) => {
  if (
    err.code === "22P02" &&
    err.where === "unnamed portal parameter $1 = '...'"
  ) {
  ...
  if (err.code === "22003") {
    res.status(400).send({ msg: "Bad request, out of range" });
  }
  if (err.code === "23502") {
